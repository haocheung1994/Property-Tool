...
<body>
					...
					<div class="row cl">
						...
						<div class="formControls col-10">
							<input type="text" id="goods_spe"
								placeholder="请填写规格(单位)" value="" class="input-text" style="width: 80%">
						</div>
			</div><br>
				...
				<div class="row cl">
						...
						<div class="formControls col-10">
							<input type="text" id="goods_price"
								placeholder="请填写价格（元）" value="" class="input-text" style="width: 80%">
						</div>
			</div><br>
			<div class="row cl">
	...
	function upload() {
		...
		var one = fn.split("#");
		//获取数组中最后一个，即文件名
		var two = one[one.length - 1];//good1.png
		//再对文件名进行截取，以取得后缀名
		var three = two.split(".");//good1,png
		//获取截取的最后一个字符串，即为后缀名
		var last = three[three.length - 1];//png
