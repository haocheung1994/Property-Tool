...
<title>物业宝-后台管理</title>
</head>
<body>
<header class="Hui-header cl"> <a class="Hui-logo l" title="H-ui.admin v2.3" href="main.html">&nbsp;&nbsp;&nbsp;稻草人物业宝</a> <a class="Hui-logo-m l" href="/" title="H-ui.admin">H-ui</a> <span class="Hui-subtitle l">V1.0</span>
...
<aside class="Hui-aside">
	...
	<div class="menu_dropdown bk_2">
		...
		<dl id="menu-product">
			...
			<dd><ul>
					<li><a _href="banIndex.html" href="javascript:void(0)"> 首页轮图</a></li>
					<li><a _href="banList.html?status=1" href="javascript:void(0)"> 商城轮图</a></li>
				</ul>
		...
		<dl id="menu-comments">
			...
			<dd>
				<ul>
					<li><a _href="cpsList.html" href="javascript:;">供应商管理</a></li>
					<li><a  _href="/main/suppliertype " href="javascript:;">供应商类型</a></li>
					<li><a  _href=" " href="javascript:;">合作商家</a></li>
				</ul>
			</dd>
		</dl>
		<dl id="menu-comments">
		...
		<dl id="menu-comments">
			...
			<dd>
				<ul>
					<li><a _href="recruitInfo.html?statu=1" href="javascript:;">招聘信息</a></li>
				</ul>
			</dd>
		</dl>

		<dl id="menu-comments">
			<dt><i class="Hui-iconfont">&#xe622;</i> 土地中标信息<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
			<dd>
				<ul>
					<li><a _href="placeInfo.html?statu=1" href="javascript:;">土地中标</a></li>
				</ul>
			</dd>
		</dl>
		...
		<dl id="menu-comments">
			<dt><i class="Hui-iconfont">&#xe622;</i> 按钮统计<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
			<dd>
				<ul>
					<li><a _href="traffic.html" href="javascript:;">招聘模块</a></li>
				</ul>
			</dd>
		</dl>
	...
	<div id="Hui-tabNav" class="Hui-tabNav">
		<div class="Hui-tabNav-wp">
			<ul id="min_title_list" class="acrossTab cl">
				<li class="active"><span title="稻草人" data-href="#">物业宝</span><em></em></li>
			</ul>
		</div>
