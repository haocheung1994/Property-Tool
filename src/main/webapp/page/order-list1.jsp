...
<body>
    ...
    <div class="sjsc-title2">
    	<h3 class="sjsc-t2l">待支付</h3>
    </div>
   <%-- <ul class="quanbu-title2">
    	<li class="current" style="display: inline;"><a href="JavaScript:;">待支付</a></li>
    	&lt;%&ndash;<li style="display: inline;"><a href="JavaScript:;">待支付</a></li>
    	<li style="display: inline;"><a href="JavaScript:;">待发货</a></li>
    	<li style="display: inline;"><a href="JavaScript:;">已发货</a></li>&ndash;%&gt;
  ...
  <%--  <div class="my-dd">
        	...
        	<div class="my-k1">
                ...
                <div class="my-p2">
                	...
                	<c:if test="${list.status==0 }">
						...
						<button class="my-btn1 f-r"  onclick="deleteorder()">取消订单</button>
						<input type="hidden" id="orderid" value="${list.order_id}" >
					</c:if>
                	<c:if test="${list.status!=0}">
	...
	<c:if test="${slist0==0}">
		<div align="center" style="font-size: 15px;margin-top: 15% ">无相关订单</div>
	</c:if>
