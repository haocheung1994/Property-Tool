...
<div class="sy-info1" style="border-bottom:4px solid #E6E6E6;">
    <ul class="info-img">
        <li>
            <a href="secGoodsList.html?is_recommend=1" class="img-1" ><img  src="images/hao-1.png" style="width:42px;height: 42px"> </a>
            <a href="secGoodsList.html?is_recommend=1" class="img-txt">电子设备</a>
        </li>
        <li>
            <a href="category.html?ctg_id=23" class="img-1" > <img  src="images/hao-2.png" style="width:42px;height: 42px"></a>
            <a href="category.html?ctg_id=23" class="img-txt">办公家具</a>
        </li>
        <li>
            <a href="category.html?ctg_id=21" class="img-1" style=""><img  src="images/hao-3.png" style="width:42px;height: 42px"></a>
            <a href="category.html?ctg_id=21" class="img-txt">劳保服装</a>
        </li>
        <li>
            <a href="menuList.html" class="img-1" ><img  src="images/hao-4.png" style="width:42px;height: 42px"></a>
            <a href="menuList.html" class="img-txt">工程工具</a>
        </li>
        <br><br><br><br>
        <li>
            <a href="category.html?ctg_id=22" class="img-1" ><img  src="images/hao-5.png" style="width:42px;height: 42px"></a>
            <a href="category.html?ctg_id=22" class="img-txt">保洁工具</a>
        </li>

        <li>
            <a href="secGoodsList.html?is_recommend=1" class="img-1" ><img  src="images/hao-4.png" style="width:42px;height: 42px"> </a>
            <a href="secGoodsList.html?is_recommend=1" class="img-txt">安防用具</a>
        </li>
        <li>
            <a href="category.html?ctg_id=23" class="img-1" > <img  src="images/hao-5.png" style="width:42px;height: 42px"></a>
            <a href="category.html?ctg_id=23" class="img-txt">办公用品</a>
        </li>

        <li>
            <a href="category.html?ctg_id=22" class="img-1" ><img  src="images/hao-10.png" style="width:42px;height: 42px"></a>
            <a href="category.html?ctg_id=22" class="img-txt">其他</a>
        </li>
