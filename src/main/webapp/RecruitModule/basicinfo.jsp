...
<form action="/basicInfoSub" name="basicForm" method="post"><br>
  <div class="mui-content"><br>
    ...
    <div class="mui-input-row">
      <span class="icon-circle  icon iconfont icon-bianji" style="color: dodgerblue;"></span>
      <span><input type="text" id ="selected_job"  placeholder="求职意向" name="expectjob" readonly  unselectable="on" style="border:0px; "></span>
    </div>
    <script>
      var expButton = document.getElementById("selected_job");
      var result_exp = document.getElementById("selected_job");
      var expPicker = new mui.PopPicker();
      expPicker.setData([{
        value:"物业项目经理",
        text:"物业项目经理"
      },{
      ...
      expButton.addEventListener('tap',function(event){
        expPicker.show(function(item){
          result_exp.value = item[0].text;
          /*console.log(nianfenPicker.innerText);*/
          console.log(item[0].text);
        });
      },false);
