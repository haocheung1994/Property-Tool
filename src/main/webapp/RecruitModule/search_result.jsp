...
<!--
            数据列表
        -->
<c:if test="${ 0 == tfirmusers.size() && myrecruitList.size() ==0}"  >
	<p style="margin-top: 30px;font-size: larger" align="center">
		无搜索结果...
	</p>
</c:if>

<c:if test="${tfirmusers.size() !=0}"  >
	<div style="padding-bottom: 15px;margin-top: 5px;">
		<span style="margin-left: 15px;color: #a4a4a4">${tfirmusers.size()}条公司结果：</span>
		<c:forEach var="recruit" items="${tfirmusers}" >

			<ul class="mui-table-view" style="margin-top: 10px; margin-left: 10px; margin-right: 10px;">
				<link href="css/font.css" rel="stylesheet" />
				<li class="mui-table-view-cell mui-media">
					<a href="/companyinfo?companyid=${recruit.companyid}">
							<div id="divcss5">
								<img class="mui-media-object mui-pull-left" src="/RecruitModule/img/firm.jpg">
							</div>
							<div class="mui-media-body">
								<p class="mui-ellipsis" style="font-family: '微软雅黑';font-size: larger;color: black;">${recruit.companyname}</p>
									<p class="mui-ellipsis" style="margin-left: auto;">${recruit.companyaddr}</p>
...
<c:if test="${myrecruitList.size() !=0}"  >
<div style="padding-bottom: 50px;">
	<span style="margin-left: 15px;color: #a4a4a4">${myrecruitList.size()}条职位结果：</span>
