...
<header class="mui-bar mui-bar-nav" >
  ...
  <span id="dingwei" class="mui-icon iconfont icon-baocun mui-pull-right" style="color: white;" onclick="editEduExpFormSub()"></span></br>
</header>
<script>
  function editEduExpFormSub()
  {
    if(CheckPost())
    {
      document.editEduExpForm.submit();
    }
  }
  function CheckPost ()
  {
...
<!--
    编辑内容
-->
<form action="/editEduExpSub" name="editEduExpForm"  id=""  method="post">
  <input type="hidden" name="eduexpid" value="${eduExpOld.eduexpid}" >
  <div class="mui-content" style="margin-top: 10px;">
    <div class="mui-input-row">
      <span class="icon-circle  icon iconfont icon-bianji" style="color: dodgerblue;"></span>
      <span ><input type="text" name="eduschoolname" id="1" value="${eduExpOld.eduschoolname}" placeholder="学校名称" style="border:0px;"></span>
    </div>

    <div class="mui-input-row">
      <span class="icon-circle  icon iconfont icon-bianji" style="color: dodgerblue;"></span>
      <span ><input type="text" name="edumajor" id="2" value="${eduExpOld.edumajor}" placeholder="所学专业" style="border:0px;"></span>
    </div>

    <div class="mui-input-row">
      <span id="graduate_time" class="icon-circle  icon iconfont icon-bianji" style="color: dodgerblue;"></span>
      <span ><input type="text" name="graduationtime" value="${eduExpOld.graduationtimeStr}" id="selected_graduate_time" placeholder="毕业年月" style="border:0px;"></span>
    </div>
    <script>
    ...
    <div class="mui-input-row">
      ...
      <span ><input type="text" name="degree" value="${eduExpOld.degree}" id="selected_education" placeholder="学历" style="border:0px;"></span>
    </div>
...
<ul class="mui-table-view" style="margin-left: 10px;margin-right: 10px;margin-bottom: 10px;">
  <a href="/deleteEduExp?eduexpid=${eduExpOld.eduexpid}">
    <button type="button" class="mui-btn mui-btn-blue mui-btn-block">删除此教育经历</button>
  </a>
</ul>
