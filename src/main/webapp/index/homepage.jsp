                ...
                geolocation.getCurrentPosition(function (r) {
                    if (this.getStatus() == BMAP_STATUS_SUCCESS) {
                        ...
                        $.ajax({
                            ...
                            dataType: "text",
                            url: "getPosition",
                            data: {"lo": r.point.lng, "la": r.point.lat},
                            success: function (msg) {
                                var jsonObj = JSON.parse(msg)
                                var city = jsonObj.result.addressComponent.city;
                                $("#userResult").text(city)
                                // alert(jsonObj.result.addressComponent.city);
    ...
    <div id="slider" class="mui-slider">
        <div class="mui-slider-group mui-slider-loop">
            ...
            <div class="mui-slider-item mui-slider-item-duplicate">
                <a href="#">
                    <img src="${indexBan[3].banImg}">
                </a>
            </div>
            <c:forEach items="${indexBan}" var="banner">
            <!-- 第一张 -->
