...
<link href="/main/css/H-ui.admin.css" rel="stylesheet"
	type="text/css" />
<link href="/main/lib/icheck/icheck.css" rel="stylesheet"
	type="text/css" />
<link href="/main/lib/Hui-iconfont/1.0.1/iconfont.css"
	rel="stylesheet" type="text/css" />
<!--[if IE 6]>
<script type="text/javascript" src="/main/lib/DD_belatedPNG_0.0.8a-min.js" ></script>
...
<body>
	<nav class="breadcrumb">
		...
		首页轮图 <span class="c-gray en">&gt;</span>  <a
	...
	<div class="pd-20" style="width: 80%">
			...
			<input id="ban_id" type="hidden" value="${banner.banId }">
			<div class="row cl">
						<label class="form-label col-2">链接地址：${banner.url}</label>
						<div class="formControls col-10">
							<input  id="url"  value="${banner.url}" class="input-text" style="width: 80%">
						</div>
					</div>
					<br>
			<div class="row cl">
				...
				<div class="row cl">
						...
						<input id="filepath" type="hidden" value="${banner.banImg}">
						<div class="formControls col-10" id="img">
							<img alt="" src="${banner.banImg}" width="200" height="100">
						</div>
				</div>
	...
	function add(){
		...
		$.ajax({
			url:'banIndexUpdate.html',
			type:'post',
			data:'ban_img='+ban_img+'&ban_id='+ban_id+'&url='+url,
			success:function(rs){
				if(rs==1){
					alert("提交成功！");
