...
<body>
	<nav class="breadcrumb">
		...
		供应商管理 <span class="c-gray en">&gt;</span>  <a
	...
	<br class="pd-20" style="width: 80%">
			...
			<div class="row cl"style="margin-left: 50px">
						...
						<div class="formControls col-10">
							供应商名：&nbsp;&nbsp;&nbsp;
							<input type="text" id="cps_name"placeholder="请填写公司名称" value="" class="input-text" style="width: 80%">
				...
				<div class="row cl"style="margin-left: 50px">
						...
						<div class="formControls col-10">
							...
							<input type="text" id="cps_price"
								placeholder="请选择供应商类型" value="" class="input-text" style="width: 80%">
						</div>
			</div><br>
					<div class="row cl"style="margin-left: 50px">
						...
						<div class="formControls col-10">
							联系电话：&nbsp;&nbsp;&nbsp;
							<input type="text" id="cps_time"
								placeholder="请填写公司常用电话" value="" class="input-text" style="width: 80%">
						</div>
			</div></br>
			<div class="row cl"style="margin-left: 50px">
				...
				<div class="formControls col-10">
					公司地址：&nbsp;&nbsp;&nbsp;
					<input type="text" id=""
						   placeholder="请填写公司地址" value="" class="input-text" style="width: 80%">
				</div>
			</div></br>
				<div class="row cl"style="margin-left: 50px">
