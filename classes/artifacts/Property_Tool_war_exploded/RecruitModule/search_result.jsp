				...
				<ul class="mui-table-view">
					<li class="mui-table-view-cell mui-media">
						<div class="mui-media-body" >
							...
							<span id="selecte_add">
							<p type="hidden" id="add_selected" style="padding:0px; margin:0px;display: inline" >${site}</p>
							</span>
							<input STYLE="float: right" type="button" onclick="NewFunc()" value="筛选">
							<input type="hidden" value="${site}" id="input_selected" name="workAddr" required >
...
<!--
            数据列表
        -->
<c:if test="${ null == myrecruitList || myrecruitList.size() ==0}"  >
