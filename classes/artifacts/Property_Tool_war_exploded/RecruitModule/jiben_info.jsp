...
<script language="javascript">
  function SendForm ()
  {
    if(CheckPost())
    {
      ...
      self.location='/myResume?userid=${userId}';
    }
  }

  function CheckPost ()
  {
    /*if (basicinfo.personname.value == "")
    {
      alert("姓名不能为空");
      basicinfo.personname.focus();
      return false;
    }*/
...
<header class="mui-bar mui-bar-nav" >
  ...
  <span id="dingwei" onclick="SendForm()" class="mui-icon iconfont icon-baocun mui-pull-right" style="color: white;"></span></br>
</header>

<!--
    编辑内容
-->
<form action="/basicInfoEdit" name="basicinfo" method="post"><br>
<div class="mui-content"><br>
  ...
  <div class="mui-input-row"><br>
    ...
    <span><input type="text" value="${BasicInfo.personname}" required placeholder="姓名" name="personname" style="border:0px;"></span>
  </div>

  <div class="mui-input-row">
    <span id = "nianfen" class="icon-circle  icon iconfont icon-bianji" style="color: dodgerblue;"></span>
    <span ><input type="text" id = "selected" name="birthtime" required value="${BasicInfo.birthtimeStr}"  placeholder="出生年份" readonly  unselectable="on" style="border:0px;"></span>
  </div>
  ...
  <div class="mui-input-row">
    ...
    <span><input type="text" id ="selected_sex" required value="${BasicInfo.personsex}" placeholder="性别" name="personsex" readonly  unselectable="on" style="border:0px; "></span>
  </div>
  <script>
  ...
  <div class="mui-input-row" style="margin-bottom: 10px;">
    ...
    <span id="selected_work_exp"><input type="text" required value="${BasicInfo.workyear}" readonly  unselectable="on"  name="workyear" style="border:0px;"></span>
  </div>
  <script>
  ...
  <div class="mui-input-row">
    <!--<label>联系电话</label>-->
    <span class="icon-circle  icon iconfont icon-bianji" style="color: dodgerblue;"></span>
    <span><input type="text" placeholder="手机号" required value="${BasicInfo.persontel}" name="persontel" style="border:0px;"></span>
  </div>
  <div class="mui-input-row" style="margin-bottom: 10px;">
    <!--<label>联系邮箱</label>-->
    <span class="icon-circle  icon iconfont icon-bianji" style="color: dodgerblue;"></span>
    <span><input type="text" placeholder="邮箱" required value="${BasicInfo.personemail}" name="personemail" style="border:0px;"></span>
  </div>
  <!--
      ===========================================================
  -->
        ...
        <a>
          <!--<span class="icon iconfont icon-dingdan" style="color: orangered;"></span>-->
             ...
             <span  style="font-size: 14px;color: #555555;font-family: '微软雅黑'">
               <input  value="${BasicInfo.personcity}" required id="selected_add"  name="personcity" readonly  unselectable="on" style="border:0px; "></span>
  ...
  <script>
    ...
    var addressPickerButton = document.getElementById('add_select');
  ...
  <div class="mui-input-row">
    <!--<label>一句话介绍</label>-->
    <span class="icon-circle  icon iconfont icon-bianji" style="color: dodgerblue;"></span>
    <span><input type="text" required value="${BasicInfo.otherinf}" name="otherinf" placeholder="一句话介绍" style="border:0px;"></span>
  </div>
  </div>
